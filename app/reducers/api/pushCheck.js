export const types = {
    UPDATE_STATE: 'pushCheck/update_state',
    REQUEST_LIST: 'pushCheck/list',
    REQUEST_ONE: 'pushCheck/one',
    REQUEST_UPDATE: 'pushCheck/update',
    REQUEST_APPROVAL: 'pushCheck/approval',
    REQUEST_DEL: 'pushCheck/del',
    REQUEST_BATHDEL: 'pushCheck/bathDel',
}
